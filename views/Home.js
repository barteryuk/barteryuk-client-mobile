...
import { View, StyleSheet, ImageBackground, Image, AsyncStorage, Animated, Dimensions } from 'react-native'
      ...
      <View style={styles.container}>
        ...
        <SlidingUpPanel showBackdrop={false} draggableRange={{ top: height - 60, bottom: 20}} animatedValue={draggedValue}>
          <View style={styles.panel}>
              { productDetail !== null ? 
                <Sliding data={productDetail} status={'homeProduct'} navigation={navigation}/>
